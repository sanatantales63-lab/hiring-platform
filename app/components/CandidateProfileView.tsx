         ...
         <div className="md:col-span-1 space-y-8">
             ...
             <div className="bg-[var(--card)] border border-[var(--border)] p-8 rounded-xl shadow-soft">
                ...
                <div className="space-y-4 text-sm font-bold text-[var(--ink-soft)]">
                   ...
                   {/* Age — calculated from DOB, visible to company too */}
                   {candidate.dob && (() => {
                     const birthYear = new Date(candidate.dob).getFullYear();
                     const currentYear = new Date().getFullYear();
                     const age = currentYear - birthYear;
                     return (
                       <div className="flex justify-between border-b border-[var(--border)] pb-4 mb-4">
                         <span className="text-[var(--muted-foreground)]">Age</span>
                         <span className="text-[var(--foreground)] font-bold">{age} yrs</span>
                       </div>
                     );
                   })()}
