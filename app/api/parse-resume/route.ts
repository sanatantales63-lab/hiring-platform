...
      2. WORK EXPERIENCE: Extract Company Name, Job Role, and Duration. ALSO extract a highly detailed and comprehensive 'summary' (3-4 descriptive sentences detailing specific core modules handled, tools used, and concrete execution tasks). Avoid generic text—ensure the summary is exhaustively informative and deeply technical based on the candidate's actual workflow history. ALWAYS infer the hierarchy 'designation' level (Choose EXACTLY ONE from: "Intern / Trainee", "Associate / Executive", "Senior Associate / Analyst", "Supervisor / Team Lead", "Manager", "Director / VP").
